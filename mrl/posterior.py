...
def compare_modalities(
    ...
    for l in log_likelihoods.values():
        assert np.all(l <= 0)
    ...
    pkl.dump(centroid_per_modality, open(outdir / "centroids.pkl", "wb"))
    pkl.dump(mean_rewards, open(outdir / "mean_rewards.pkl", "wb"))
    pkl.dump(proj_mean_rewards, open(outdir / "proj_mean_rewards.pkl", "wb"))
    pkl.dump(dispersion_centroid_per_modality, (outdir / "dispersions_centroid.pkl").open("wb"))
